 ...
 */
public class OwnerTradeListAdapter extends RecyclerView.Adapter<OwnerTradeListAdapter.ViewHolder> {
    ...
    public OwnerTradeListAdapter(List<Card> card, AddTradeActivity act){
        this.cards = card;
        this.act = act;
    }
