 ...
 */
public class OwnerViewTradeAdapter extends RecyclerView.Adapter<OwnerViewTradeAdapter.ViewHolder> {
        ...
        public ViewHolder(View v) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    myIntent.putExtra("com.sherpasteven.sscte.trades", "owner");
    ...
    public OwnerViewTradeAdapter(List<Card> card, ViewTradeActivity activity, int tradelistpos){
        this.cards = card;
        this.act = activity;
