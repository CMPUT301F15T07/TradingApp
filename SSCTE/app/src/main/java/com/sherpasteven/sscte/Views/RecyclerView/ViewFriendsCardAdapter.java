 ...
 */
public class ViewFriendsCardAdapter extends RecyclerView.Adapter<ViewFriendsCardAdapter.ViewHolder> {
        ...
        public ViewHolder(View v) {
            ...
            v.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    myIntent.putExtra("com.sherpasteven.sscte.friendscard", position);
    ...
    public ViewFriendsCardAdapter(List<Card> card, int position){
        this.cards = card;
